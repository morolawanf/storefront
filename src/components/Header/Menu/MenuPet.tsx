...
const MenuPet = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setFixedHeader(scrollPosition > 140);
  ...
  return (
    <>
      <div className={`header-menu style-eight ${fixedHeader ? " fixed" : "relative"} bg-surface w-full md:h-[84px] h-[64px]`}>
                    ...
                    <div className="mega-menu absolute top-[44px] left-0 bg-white w-screen">
                      <div className="container">
                        <div className="flex justify-between py-8">
                          <div className="nav-link basis-9/12 grid grid-cols-4 gap-y-8">
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Chairs</div>
                              <ul>
                                <li>
                                  <div
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Tables</div>
                              <ul>
                                <li>
                                  <div
                                    onClick={() => handleTypeClick("shirt")}
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Basket and Bins</div>
                              <ul>
                                <li>
                                  <div
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Bowls and Basins</div>
                              <ul>
                                <li>
                                  <div
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Containers and Cooolers</div>
                              <ul>
                                <li>
                                  <div
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Buckets</div>
                              <ul>
                                <li>
                            ...
                            <div className="nav-item">
                              <div className="text-button-uppercase pb-2">Home and Soviner</div>
                              <ul>
                                <li>
                                  <div
