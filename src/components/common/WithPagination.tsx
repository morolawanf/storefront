        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-line">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-lg border border-line transition-colors ${
                canGoPrevious
              ...
              {pageNumbers.map((page, index) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-center min-w-10 h-10 px-3 rounded-lg border transition-colors ${
                      isActive
